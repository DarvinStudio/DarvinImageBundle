...
/**
 * Image entity size resolver
 */
class ImageEntitySizeResolver implements SizeResolverInterface
{
    /**
    ...
    /**
     * @param \Darvin\ImageBundle\SizeManager\SizeManagerInterface $sizeManager Image size manager
     */
